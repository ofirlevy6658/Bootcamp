...
// 1.5 -> db.resturants.updateOne({_id:ObjectId("607d3d557c25bb3706876bad")}).adress
// 1.6 -> db.resturants.updateOne({_id:ObjectId("607d3d557c25bb3706876bad")}).adress.coordinates
...
// 1.10 -> db.resturants.updateOne({_id:ObjectId("607d3d557c25bb3706876bad")},{$push:{reviews:{date" : isoDate("2019-01-01T00:00:00Z"),"score"8.5}})
...
// 1.14	db.resturants.updateOne({_id:ObjectId("607d3ca57c25bb3706876ba4")},{$inc:{"reviews.1.score":2}})
// 1.15 db.resturants.updateOne({_id:ObjectId("607d3ca57c25bb3706876ba4")},{$inc:{"reviews.1.score":-1}})
